...
def main(settings):
    ...
    if 'opt_hyperparams_path' in settings:
        ...
        tuner.search(n_configurations=5, hyperparam_space=opt_hyperparams, main_metric=settings['main_metric'],
...
if __name__ == '__main__':
    # Parse settings file
    with open('test_files/test_ml_pipeline.yml', 'r') as stream:
        try:
